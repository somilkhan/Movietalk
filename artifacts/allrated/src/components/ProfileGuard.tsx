...
export function ProfileGuard({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Profile selection is a page, not a global navigation guard. Once authenticated,
    // normal routes must remain navigable even when no active local profile exists yet.
