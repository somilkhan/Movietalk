export function GlobalUiFixes() {
  return <style>{`
    ...
    input:focus-visible, select:focus-visible, button:focus-visible { box-shadow: none !important; }
    a:focus-visible { box-shadow: 0 0 0 1px rgba(255,255,255,.14) !important; }
