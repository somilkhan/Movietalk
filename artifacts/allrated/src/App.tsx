...
import { BingrDesktopSidebar } from "@/components/BingrDesktopSidebar";
...
function PageLoader() {
  return <div className="min-h-screen flex items-center justify-center bg-black"><div role="status" aria-label="Loading" className="w-9 h-9 border-2 border-white/10 border-t-white/80 rounded-full animate-spin" /></div>;
}
