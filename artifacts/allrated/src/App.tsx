...
const Watch = lazy(() => import("@/pages/BingrWatchWithDownloads"));
...
function Router() {
  ...
  return <><ScrollToTop /><Switch>
    ...
    <Route><div className="min-h-screen bg-black text-white flex flex-col"><DesktopSidebar /><main className={cn("flex-1 mobile-content md:pb-0 animate-slide-up", "md:ml-[80px]")}><Switch>
