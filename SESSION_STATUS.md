...
## 2026-08-20 — Bingr parity Phase 2 home + Explore/search polish
...
- Explore/search page now has a more Bingr-like Discover/Explore hierarchy, larger responsive search surface, cleaner result metadata, responsive type filtering, mobile filter popover, and preserved recent-search behavior.
